...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/google-genai-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/google-genai-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add google-genai
# for installing globally
pixi global install google-genai
```
...
It is possible to list all of the versions of `google-genai` available on your platform:
...
```
pixi search google-genai --channel conda-forge
```
